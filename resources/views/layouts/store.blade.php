                        ...
                        <div class="filterbox">
                            ...
                            <div class="filtercontent">
                                ...
                                <div class="filteritem">
                                    ...
                                    <label for="filter_brand{{$brand->id}}">{{$brand->name_brand}}</label><span style="float:right">({{rand(0,100)}})</span>
                                </div>
                                @endforeach
                            </div>
                        </div>
...
{{--                                </div>--}}
                        ...
                        <div class="filterbox">
                            ...
                            <div class="filtercontent">
                                <div class="filteritem">
                                    ...
                                    <label for="filter_state_ac">Acre</label><span style="float:right">({{rand(0,100)}})</span>
                                </div>
                                <div class="filteritem">
                                ...
                                <div class="filteritem">
                                    ...
                                    <label for="filter_state_pa">Pará</label><span style="float:right">({{rand(0,100)}})</span>
                                </div>
                                <div class="filteritem">
                        ...
                        <div class="filterbox">
                            ...
                            <div class="filtercontent">
                                <div class="filteritem">
                                    <input type="checkbox" name="filter[region][]" value="norte" id="filter_region_norte" />
                                    <label for="filter_region_norte">Norte</label><span style="float:right">({{rand(0,100)}})</span>
                                </div>
                                <div class="filteritem">
                                    <input type="checkbox" name="filter[region][]" value="nordeste" id="filter_region_nordeste" />
                                    <label for="filter_region_nordeste">Nordeste</label><span style="float:right">({{rand(0,100)}})</span>
                                </div>
                                <div class="filteritem">
                                    <input type="checkbox" name="filter[region][]" value="centro-oeste" id="filter_region_centro" />
                                    <label for="filter_region_centro">Centro-Oeste</label><span style="float:right">({{rand(0,100)}})</span>
                                </div>
                                <div class="filteritem">
                                    <input type="checkbox" name="filter[region][]" value="sudeste" id="filter_region_sudeste" />
