...
@section('breadcrumb')
    <div class="col-md-12 col-12 align-self-center">
        <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item active">Cargos Vinculados</li>
        </ol>
    </div>
@endsection
...
@section('content')
    <div class="widget-content searchable-container list">
        ...
        <div class="card card-body mb-0">
            <form action="{{route("usuarios.cargos.filter", $user->id)}}" method="post">
                @csrf
                <div class="mb-2 p-2">
                    <div class="row mb-3">
                        <div class="flex-1">
                    ...
                    <div class="row">
                        <div class="input-group">
                            ...
                            <div class="input-group-append ml-1">
                                <a href="{{route('usuarios.cargo.available', $user->id)}}" class="btn btn-info" style="border-radius: 5px;padding: 15px;" >
                                    <i class="mdi mdi-plus font-16 mr-1 ml-2"></i> Vinncular novo cargo
                                </a>
                            </div>
                        </div>
                    </div>
                        ...
                        <tr class="search-items">
                            ...
                            <td class="text-right">
                                <div class="action-btn d-flex justify-content-end">
                                    <a href="{{ route('usuarios.cargo.detach', [$user->id, $role->id]) }}"
