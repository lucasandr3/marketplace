...
@section('title', "Documento - {$document->number}")
...
@section('breadcrumb')
    <div class="col-md-5 col-12 align-self-center">
        <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item active">Document - {{$document->number}}</li>
        </ol>
    </div>
@endsection
                            ...
                            <div class="tab-pane" id="profile">
                                <div class="table-responsive">
                                    <table class="table table-striped search-table v-middle">
                                        ...
                                        <tr>
                                            <th class="text-dark font-weight-bold">Nº. Item</th>
                                            <th class="text-dark font-weight-bold">Nº Lote</th>
                                            <th class="text-dark font-weight-bold">Item</th>
                                            <th class="text-dark font-weight-bold">Quantidade</th>
                                            <th class="text-dark font-weight-bold">Valor Únit.</th>
