...
@section('content-no-container')
    ...
    <div class="email-app todo-box-container" style="margin-top: -14px;">
        <!-- ============================================================== -->
        <!-- Left Part -->
        <!-- ============================================================== -->
        <div class="left-part list-of-tasks">
            <a class="ti-menu ti-close btn btn-success show-left-part d-block d-md-none" href="javascript:void(0)"></a>
            <div class="scrollable bg-white" style="height:100%;">
                <div class="p-3">
                    <a class="waves-effect waves-light btn btn-info d-block" href="javascript: void(0)" id="add-task">Novo Documento</a>
                </div>
                ...
                <ul class="list-group">
                    ...
                    <li class="list-group-item p-0 border-0">
                        <a href="javascript:void(0)" class="todo-link active list-group-item-action p-3 d-block" id="all-todo-list"><i class="mdi mdi-folder"></i> Credenciamento <span class="todo-badge badge badge-info float-right"></span></a>
                    </li>
                    <li class="list-group-item p-0 border-0">
                        <a href="javascript:void(0)" class="todo-link list-group-item-action p-3 d-block" id="current-task-important"> <i class="mdi mdi-folder"></i> Regularidade Fiscal <span class="todo-badge badge badge-warning float-right"></span></a>
                    </li>
                    <li class="list-group-item p-0 border-0">
                        <a href="javascript:void(0)" class="todo-link list-group-item-action p-3 d-block" id="current-task-done"> <i class="mdi mdi-folder"></i> Qualificação Econômica e Financeira <span class="todo-badge badge badge-success float-right"></span></a>
                    </li>
                    <li class="list-group-item p-0 border-0">
                        <a href="javascript:void(0)" class="todo-link list-group-item-action p-3 d-block" id="current-task-done"> <i class="mdi mdi-folder"></i> Habilitação Jurídica <span class="todo-badge badge badge-success float-right"></span></a>
                    </li>
                    <li class="list-group-item p-0 border-0">
                        <hr>
                    </li>
                    <li class="list-group-item p-0 border-0">
                        <a href="javascript:void(0)" class="list-group-item-action p-3 d-block" id="current-todo-delete"> <i class="mdi mdi-delete"></i> Trash </a>
                    </li>
                </ul>
            </div>
        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="input-group searchbar">
                                    ...
                                    <input type="text" class="form-control w-100" placeholder="Search Tasks Here" aria-describedby="search">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <a class="waves-effect waves-light btn btn-info d-block" href="javascript: void(0)" id="add-task">Novo Documento</a>
                            ...
                            <div class="col-md-3">
                                <a class="waves-effect waves-light btn btn-outline-secondary d-block" href="javascript: void(0)" id="add-task">Marcar todos</a>
                            </div>
                            <div class="col-md-2">
                                <a class="waves-effect waves-light btn btn-outline-secondary d-block" href="javascript: void(0)" id="add-task">Download</a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="inner-item d-flex align-items-start">
                                <div class="w-100">
                                    ...
                                    <div class="checkbox checkbox-info d-flex align-items-start">
                                        <input type="checkbox" class="material-inputs" id="checkbox1">
                        ...
                        <div class="todo-item all-todo-list p-3 border-bottom position-relative current-task-done">
                            <div class="inner-item d-flex align-items-start">
                                <div class="w-100">
                                    <!-- Checkbox -->
                                    <div class="checkbox checkbox-info d-flex align-items-start">
                                        <input type="checkbox" class="material-inputs" id="checkbox2" checked>
                        ...
                        <div class="todo-item all-todo-list p-3 border-bottom position-relative current-task-important">
                            <div class="inner-item d-flex align-items-start">
                                <div class="w-100">
                                    <!-- Checkbox -->
                                    <div class="checkbox checkbox-info d-flex align-items-start">
                                        <input type="checkbox" class="material-inputs" id="checkbox3">
                                        <label class="custom-control-label" for="checkbox3"></label>
                                        <div>
                                            <!-- Content -->
                                            <div class="content-todo">
                                                <h5 class="font-medium font-16 todo-header mb-0" data-todo-header="Give Review for design in Material pro Vue Admin">Give Review for design in Material pro Vue Admin</h5>
                                                <div class="todo-subtext text-muted"
                        ...
                        <div class="todo-item all-todo-list p-3 border-bottom position-relative current-todo-delete">
                            <div class="inner-item d-flex align-items-start">
                                <div class="w-100">
                                    <!-- Checkbox -->
                                    <div class="checkbox checkbox-info d-flex align-items-start">
                                        <input type="checkbox" class="material-inputs" id="checkbox4">
                        ...
                        <div class="todo-item all-todo-list p-3 border-bottom position-relative current-task-important">
                            <div class="inner-item d-flex align-items-start">
                                <div class="w-100">
                                    <!-- Checkbox -->
                                    <div class="checkbox checkbox-info d-flex align-items-start">
                                        <input type="checkbox" class="material-inputs" id="checkbox5">
