            ...
            <div class="scrollable" style="height:100%;">
                ...
                <ul class="list-group">
                    ...
                    <li class="list-group-item p-0 border-0">
                        <a href="javascript:void(0)" class="todo-link active list-group-item-action p-3 d-block" id="all-todo-list"><i class="mdi mdi-format-list-bulleted"></i> All Tasks <span class="todo-badge badge badge-info float-right"></span></a>
                    </li>
                    <li class="list-group-item p-0 border-0">
                        <a href="javascript:void(0)" class="todo-link list-group-item-action p-3 d-block" id="current-task-important"> <i class="mdi mdi-star"></i> Important <span class="todo-badge badge badge-warning float-right"></span></a>
                    </li>
                    <li class="list-group-item p-0 border-0">
                        <a href="javascript:void(0)" class="todo-link list-group-item-action p-3 d-block" id="current-task-done"> <i class="mdi mdi-send"></i> Complete <span class="todo-badge badge badge-success float-right"></span></a>
                    </li>
                    <li class="list-group-item p-0 border-0">
                        <hr>
                    </li>
