...
@section('content')
    <div class="widget-content searchable-container list">
        <div class="card mb-2">
            <div class="card-body">
                <x-filtros route="relatorios.filter" :filters="$filters"></x-filtros>
            </div>
        </div>
                    ...
                    <table class="table table-striped search-table v-middle">
                        ...
                        @foreach($process as $proc)
                            ...
                            <tr class="search-items">
                                ...
                                <td>
                                    {{$proc->comprador}} / {{$proc->state}}
                                </td>
                                <td class="text-right">
                                    <div class="action-btn">
                                        <a href="{{route('relatorios.processo', $proc->id)}}"
                                           class="btn waves-effect waves-light btn-info" data-toggle="tooltip" title="Relatórios">
