                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    <h4 class="card-title font-weight-bold text-dark mb-0">
                                        <i class="mdi mdi-file-check mr-2 text-dark"></i>
                                        Minhas cotações<br>
                                    </h4>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="input-group">
                            <input type="text" class="form-control col-10"
                                   ...
                                   placeholder="Digite o código da cotação" value="{{$filters['term'] ?? ''}}"
                                   name="term">
...
{{--                    <div style="border-radius: 5px;flex: 1;" class="p-3 bg-light-success d-flex justify-content-aroun">--}}
{{--                        <div>--}}
{{--                            <span class="font-weight-bold">Média de Preço Orçado: </span><span id="media-banco-orcado">R$&nbsp;0,00</span>--}}
{{--                        </div>--}}
{{--                        <div>--}}
{{--                            <span class="font-weight-bold">Média de Preço Homologado: </span><span id="media-banco-homologado">R$&nbsp;0,00</span>--}}
{{--                        </div>--}}
{{--                    </div>--}}
{{--                </div>--}}
                                ...
                                <div id="collapse{{$key}}" class="collapse" aria-labelledby="headingOne"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div
                                            ...
                                            <div>
                                                <a href="{{route('cotacoes.produtos', $quotation->reference)}}" class="btn btn-secondary">
