...
@section('content')
    <div class="row">
        <div class="col-12">
            <form method="post" action="{{route('judgments.store')}}">
                @csrf
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Cadastro de Julgamento</h4>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control bagde" placeholder="Digite o nome do tipo de julgmento"
                                   aria-label="name" aria-describedby="basic-addon1" name="judgment"
                                   value="{{ old('judgment') }}" required autocomplete="name" autofocus>
                        </div>
