...
@section('breadcrumb')
    <div class="col-md-5 col-12 align-self-center">
        <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item active">Edição Tipo</li>
        </ol>
    </div>
@endsection
...
@section('content')
    <div class="row">
        <div class="col-12">
            <form method="post" action="{{route('judgments.update', $judgment->id)}}">
                @csrf
                @method('PUT')
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Edição de Tipo - {{$judgment->judgment}}</h4>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control bagde" placeholder="Digite o nome da unidade"
                                   aria-label="name" aria-describedby="basic-addon1" name="judgment"
                                   value="{{ $judgment->judgment ?? old('judgment') }}" required autocomplete="name" autofocus>
                        </div>
