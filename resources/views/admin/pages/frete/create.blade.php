...
@section('content')
    <div class="row">
        <div class="col-12">
            <form method="post" action="{{route('frete.store')}}">
                @csrf
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-2">
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="shipping_code_contract"
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control" name="shipping_pass_contract"
                        ...
                        <div class="row mt-4">
                            <div class="col-md-3 mb-3">
                                <input name="shipping_active" class="material-inputs" type="radio" value="1" id="s-ativo" checked="">
                                <label for="s-ativo">Ativo</label>
                            </div>
                            <div class="col-md-3 mb-3">
                                <input name="shipping_active" class="material-inputs" type="radio" value="0" id="s-inativo">
