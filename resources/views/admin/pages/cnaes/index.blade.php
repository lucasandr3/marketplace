...
@section('breadcrumb')
    <div class="col-md-5 col-12 align-self-center">
        <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item active">CNAES</li>
        </ol>
    </div>
@endsection
...
@section('content')
    <div class="widget-content searchable-container list">
        ...
        <div class="card card-body mb-0">
            <form action="{{route("cnaes.filter")}}" method="post">
                @csrf
                <div class="mb-2 p-2">
                    <div class="row mb-3">
                        <div class="flex-1">
                    ...
                    <div class="row">
                        <div class="input-group">
                            <input type="text" class="form-control col-10" style="height: 60px !important;width: 100%;border-top-right-radius: 5px;border-bottom-right-radius: 5px;"
                                   placeholder="Digite a descrição ou código do cnae" value="{{$filters['term'] ?? ''}}" name="term">
            ...
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table table-striped search-table v-middle">
                        ...
                        <tr>
                            <th class="text-light font-weight-bold">Código</th>
