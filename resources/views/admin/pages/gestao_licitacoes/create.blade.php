    ...
    <div class="col-12">
        <div class="card mb-1">
            <div class="card-body d-flex justify-content-between align-items-center">
                <div>
                    <p class="mb-0 font-weight-bold">Selecione o Fornecedor:</p>
                </div>
                <div class="mx-5" style="flex:1">
                    <select class="select2 form-control custom-select" style="width: 100%; height:36px;">
                        <option>Selecione o fornecedor</option>
                        @foreach($supliers as $suplier)
                            <option value="{{$suplier->id}}">{{$suplier->nome}}</option>
                        @endforeach
                    </select>
{{--                    <select class="form-control" id="select-fornecedores-contrato">--}}
{{--                        <option value="selecione">Selecione um fornecedor para criar contrato</option>--}}
{{--                    </select>--}}
                </div>
            </div>
        </div>
                        ...
                        <div class="col-sm-12 col-md-12">
                            <div class="mb-3">
                                <label for="objetoContrato" class="control-label col-form-label">Objeto <small
                                        class="text-primary">( obrigatório )</small></label>
                                <textarea class="form-control" rows="3" id="objetoContrato" required="true"
