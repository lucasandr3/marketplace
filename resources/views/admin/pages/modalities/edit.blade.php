...
@section('breadcrumb')
    <div class="col-md-5 col-12 align-self-center">
        <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item active">Edição Modalidade</li>
        </ol>
    </div>
@endsection
            ...
            <form method="post" action="{{route('modalities.update', $modality->id)}}">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Edição da Unidade - {{$modality->type}}</h4>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control bagde" placeholder="Digite o nome da unidade"
                                   ...
                                   value="{{ $modality->type ?? old('type') }}" required autocomplete="name" autofocus>
                        </div>
