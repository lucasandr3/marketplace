...
@section('content')
    <div class="widget-content searchable-container list">
        <div class="card mb-2">
            <div class="card-body">
                <x-filtros route="products" :filters="$filters"></x-filtros>
            </div>
        </div>
                    ...
                    <table class="table table-striped search-table v-middle mb-0">
                        ...
                        @foreach($products as $product)
                            ...
                            <tr class="search-items">
                                ...
                                <td>
                                    <span class=""><strong>{{$product->store()->first()->name}}</strong></span>
                                </td>
                                <td class="text-right">
                                    <div class="action-btn">
                                        ...
                                        <a href="{{route('products.show', $product->id)}}" class="btn waves-effect waves-light btn-warning" data-toggle="tooltip" title="Ver">
