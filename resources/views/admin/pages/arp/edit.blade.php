                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-4">
                                <div class="form-group">
                                    <label class="control-label col-form-label">Nome: <span class="text-info">(obrigatório)</span></label>
                            ...
                            <div class="col-sm-12 col-md-4">
                                <div class="form-group">
                                    <label class="control-label col-form-label">Fantasia: <span class="text-info">(obrigatório)</span></label>
                            ...
                            <div class="col-sm-12 col-md-4">
                                <div class="form-group">
                                    <label class="control-label col-form-label">E-mail: <span class="text-info">(obrigatório)</span></label>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-4">
                                <div class="form-group">
                                    <label class="control-label col-form-label">CNPJ/CPF: <span class="text-info">(obrigatório)</span></label>
                            ...
                            <div class="col-sm-12 col-md-4">
                                <div class="form-group">
                                    <label class="control-label col-form-label">Telefone Comercial: <span
                                            class="text-info">(obrigatório)</span></label>
                            ...
                            <div class="col-sm-12 col-md-4">
                                <div class="form-group">
                                    <label class="control-label col-form-label">Celular: <span class="text-info">(obrigatório)</span></label>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-3">
                                <div class="form-group">
                                    <label class="control-label col-form-label">CEP: <span class="text-info">(obrigatório)</span></label>
                                    <input type="text" class="form-control" name="cep" placeholder="Informe o cep" value="{{$fornecedor->cep ?? old('cep')}}">
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-9">
                                <div class="form-group">
                                    <label class="control-label col-form-label">Logradouro: <span class="text-info">(obrigatório)</span></label>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-3">
                                <div class="form-group">
                                    <label class="control-label col-form-label">Cidade: <span class="text-info">(obrigatório)</span></label>
                            ...
                            <div class="col-sm-12 col-md-3">
                                <div class="form-group">
                                    <label class="control-label col-form-label">Número: <span class="text-info">(obrigatório)</span></label>
                            ...
                            <div class="col-sm-12 col-md-3">
                                <div class="form-group">
                                    <label class="control-label col-form-label">Bairro: <span class="text-info">(obrigatório)</span></label>
