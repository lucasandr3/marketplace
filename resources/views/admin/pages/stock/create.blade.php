        ...
        <div class="card">
                    ...
                    <div class="tab-pane show active" id="home">
                        <div class="card-body">
                            <h4 class="card-title h4-processo" style="margin-top: -20px;">
                                <i class="mdi mdi-file-document"></i> Ata de Registro de Preço
                            </h4>
                            <div class="row">
                                    ...
                                    <div class="mt-2">
                                        <div class="n-chk align-self-center">
                                            <div class="checkbox checkbox-info">
                                                <input type="checkbox" name="bol_arp"
                                                       class="material-inputs contact-chkbox"
                                                       id="checkbox-arp-process" value="1">
                                                <label class="" for="checkbox-arp-process">Gerar Ata de Registro de Preço</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12 col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="year" required="true"
                                               data-campo="Ano do Contrato" placeholder="0000" value="{{date('Y')}}" >
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-4">
                                    <div class="mb-3">
                                ...
                                <div class="col-sm-12 col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control" name="init_session" required="true"
                                               data-campo="Ano do Contrato" placeholder="0000" value="" >
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-4">
                                    <div class="mb-3">
                                ...
                                <div data-repeater-list="items">
                                    <div data-repeater-item="">
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-1">
                                                    <label>Und:</label>
                                                    <input type="text" name="items[unit]" class="form-control" placeholder="Und">
                                                </div>
            ...
            <div class="card-footer d-flex gap-10">
                ...
                <div class="text-end">
                    ...
                    >
                        <i class="fa fa-check"></i> Salvar Processo
                    </button>
                </div>
            </div>
            </form>
